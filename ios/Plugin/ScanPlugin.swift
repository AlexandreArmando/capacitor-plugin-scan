...
@objc(ScanPlugin)
public class ScanPlugin: CAPPlugin {
    private let implementation = scan()
    ...
    private func cameraSettings(from call: CAPPluginCall) -> CameraSettings {
        ...
        // direction
        settings.direction = CameraDirection.rear
        // resultType
        settings.resultType = CameraResultType.base64
        
        // saveToGallery
        settings.saveToGallery = false

        // correctOrientation
        settings.shouldCorrectOrientation = true
...
extension ScanPlugin: UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate {
...
@available(iOS 14, *)
extension ScanPlugin: PHPickerViewControllerDelegate {
...
private extension ScanPlugin {
    ...
    func presentCameraPicker() {
        ...
        // select the input
        picker.sourceType = self.settings.source
        picker.cameraDevice = self.settings.direction
